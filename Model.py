...
class ARCHModel():
    ...
    def __init__(
        ...
        distribution: Optional[LogNormal] = None,
    ...
    def fit(
        ...
        sigma2 = v.compute_variance(sv_volatility, resids, sigma2, backcast, var_bounds)
        ...
        with open("resids", "wb") as fp:   #Pickling
            pickle.dump(resids, fp)
        ...
        vol_final = cast(Float64Array, np.sqrt(sigma2))

        names = ["mean1", "omega", "alpha1", "beta1"]
